...
package com.packtpub.hornetqmessagingdevelopersguidemaven.chapter03;
...
public class MyCoreSession {
	...
	public static void close() throws HornetQException{
        ...
        public static void setQueue(String queuename) throws HornetQException, Exception 
        {
            if (session == null)
                MyCoreSession.getSession().createQueue(queuename, queuename,true);                
        }
